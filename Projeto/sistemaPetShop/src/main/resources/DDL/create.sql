CREATE TABLE tb_cartao (id_cartao BIGINT AUTO_INCREMENT NOT NULL UNIQUE, str_bandeira VARCHAR(255), date_dataValidade DATE, str_numero VARCHAR(255), fk_cliente BIGINT, PRIMARY KEY (id_cartao))
